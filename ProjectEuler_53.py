...
# for 1 <= r <= n <= 100
# n choose r = n!/(r!(n-r)!)
# Nature of that formula means there is a symetry around the halfway point
# e.g 5C1 = 5C4, 5C2 = 5C3
# So we only ever need to go up to halfway for each number
# We can also use the symmetry of nCk
# up to the halfway point it's strictly increasing
# So, using the example from the question, 23C10 > 10^6
# Implies that 23C11, 23C12, 23C13 > 10^6
# Furthermore, we can use the fact that 100C3 < 10^6
